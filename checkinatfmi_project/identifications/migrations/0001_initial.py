...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Cardowner'
        db.create_table(u'identifications_cardowner', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, blank=True)),
            ('faculty_number', self.gf('django.db.models.fields.IntegerField')(unique=True)),
            ('grade', self.gf('django.db.models.fields.IntegerField')()),
            ('specialty', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['university.Specialty'])),
            ('susi_name', self.gf('django.db.models.fields.CharField')(max_length=63, null=True, blank=True)),
            ('sudi_password', self.gf('django.db.models.fields.CharField')(max_length=63, null=True, blank=True)),
        ))
        db.send_create_signal(u'identifications', ['Cardowner'])

        # Adding model 'Book'
        db.create_table(u'identifications_book', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('isbn', self.gf('django.db.models.fields.CharField')(max_length=63)),
        ))
        db.send_create_signal(u'identifications', ['Book'])


    def backwards(self, orm):
        # Deleting model 'Cardowner'
        db.delete_table(u'identifications_cardowner')

        # Deleting model 'Book'
        db.delete_table(u'identifications_book')
