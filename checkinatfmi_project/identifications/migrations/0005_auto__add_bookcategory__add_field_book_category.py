...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'identifications_bookcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ))
        db.send_create_signal(u'identifications', ['BookCategory'])

        # Adding field 'Book.category'
        db.add_column(u'identifications_book', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['identifications.BookCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BookCategory'
        db.delete_table(u'identifications_bookcategory')

        # Deleting field 'Book.category'
        db.delete_column(u'identifications_book', 'category_id')
