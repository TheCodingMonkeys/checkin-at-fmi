...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'identifications_book', 'cover',
                      self.gf('django_resized.forms.ResizedImageField')(default='', max_length=100, max_width=400, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.cover'
        db.delete_column(u'identifications_book', 'cover')
