...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book.year'
        db.alter_column(u'identifications_book', 'year', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Book.year'
        raise RuntimeError("Cannot reverse this migration. 'Book.year' and its values cannot be restored.")
