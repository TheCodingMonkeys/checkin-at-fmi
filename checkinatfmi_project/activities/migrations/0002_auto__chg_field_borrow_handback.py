...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Borrow.handback'
        db.alter_column(u'activities_borrow', 'handback_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['activities.Activity']))

    def backwards(self, orm):

        # Changing field 'Borrow.handback'
        db.alter_column(u'activities_borrow', 'handback_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['activities.Activity']))
